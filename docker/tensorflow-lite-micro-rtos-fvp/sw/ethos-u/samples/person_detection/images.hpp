...
#define NUMBER_OF_IMAGES  (4U)
#define IMAGE_DATA_SIZE  (9216U)

extern const unsigned char JP_Kyoto_kimono[IMAGE_DATA_SIZE];
extern const unsigned char person_male_man_men[IMAGE_DATA_SIZE];
extern const unsigned char POV_cat[IMAGE_DATA_SIZE];
extern const unsigned char tree[IMAGE_DATA_SIZE];
