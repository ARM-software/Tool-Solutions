...
docker exec -t $TORCH_BUILD_CONTAINER bash -c "source /tmp/env && unset OVERRIDE_PACKAGE_VERSION MAX_JOBS && bash $PYTORCH_ROOT/.ci/aarch64_linux/aarch64_ci_build.sh"
