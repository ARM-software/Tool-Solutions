...
* To obtain an evaluation license for the Cortex-M4 and Cortex-M0+ Fast Models, visit [Arm support](https://developer.arm.com/support) and request a license for the Cortex-M4 and Cortex-M0+ Fast Models.
